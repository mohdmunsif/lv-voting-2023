                            ...
                            <ul class="absolute w-44 text-left font-semibold bg-white shadow-dialog rounded-xl z-10 py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0"
                                ...
                                @can('update', $comment)
                                    <li>
                                        <a href="#"
                                            @click.prevent="
                                        isOpen = false
                                        Livewire.dispatch('setEditComment', {{ $comment->id }})
                                    "
                                ...
                                @can('delete', $comment)
                                    <li>
                                        <a href="#"
                                            @click.prevent="
                                        isOpen = false
                                        Livewire.dispatch('setDeleteComment', {{ $comment->id }})
                                    "
                                            class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">
                                            Delete Comment
                                        </a>
                                ...
                                <li>
                                    <a href="#"
                                        @click.prevent="
                                        isOpen = false
                                        Livewire.dispatch('setMarkAsSpamComment', {{ $comment->id }})
                                    "
                                        class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">
                                        Mark as Spam
                                    </a>
                                    ...
                                    @if ($comment->spam_reports > 0)
                                        <li>
                                            <a href="#"
                                                @click.prevent="
                                            isOpen = false
                                            Livewire.dispatch('setMarkAsNotSpamComment', {{ $comment->id }})
                                        "
                                                class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">
                                                Not Spam
                                            </a>
